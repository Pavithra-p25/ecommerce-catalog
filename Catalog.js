            ...
            <tr key={prod.id}>
              ...
              <td>
                {editingProductId === prod.id ? (
                  <input name="name" value={editingProduct.name} onChange={handleChange} />
                ) : prod.name}
              </td>
              <td>
                {editingProductId === prod.id ? (
              ...
              <td>
                {editingProductId === prod.id ? (
                  <input name="description" value={editingProduct.description} onChange={handleChange} />
                ) : prod.description}
              </td>
              <td>
                {editingProductId === prod.id ? (
                  <input name="price" value={editingProduct.price} onChange={handleChange} />
                ) : prod.price}
              </td>
              <td>
                {editingProductId === prod.id ? (
                  <input name="stock" value={editingProduct.stock} onChange={handleChange} />
                ) : prod.stock}
              </td>
              <td>
                {editingProductId === prod.id ? (
                  <input name="supplier" value={editingProduct.supplier} onChange={handleChange} />
                ) : prod.supplier}
              </td>
              <td>
                {editingProductId === prod.id ? (
